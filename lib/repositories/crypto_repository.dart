...
import 'package:crytocurrecy_with_bloc/models/coin_model.dart';
import 'package:crytocurrecy_with_bloc/repositories/base_crypto_repository.dart';
  ...
  Future<List<Coin>> getTopCoins({int page}) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        coinList.forEach(
          (json) => coins.add(Coin.formJson(json)),
          //converts JSON that we get from request.body to our Coin model
        );
      }
      return coins;
    } catch (err) {
